...
class Tests:
    ...
    @command()
    def set_complex_double(self, z64):
        return self.client.recv_bool()

    @command()
    def set_complex_float_double(self, u, z32, z64, i):
        return self.client.recv_bool()
    ...
    @command()
    def send_std_array_cplx_float(self, mul):
    ...
    @command()
    def send_std_vector_cplx_double(self, add):
    ...
    @command()
    def rcv_std_array_cplx_float(self, u, f, arr, d):
        return self.client.recv_bool()
...
@pytest.mark.parametrize('tests', [tests, tests_unix])
def test_set_complex_double(tests):
    assert tests.set_complex_double((1.428571428571428492127 + 2.654798454646j))

@pytest.mark.parametrize('tests', [tests, tests_unix])
def test_set_complex_float_double(tests):
    assert tests.set_complex_float_double(
                2225073854759576792,
                (0.4294967 + 0.3559151j),
                (0.4741953746153866 + 0.314159265358979323846j),
                -9223372036854775805)
...
@pytest.mark.parametrize('tests', [tests, tests_unix])
def test_send_std_vector_cplx_double(tests):
    add = (0.31645 + 0.23346j)
    array = tests.send_std_vector_cplx_double(add)
...
@pytest.mark.parametrize('tests', [tests, tests_unix])
def test_send_std_array_cplx_float(tests):
...
@pytest.mark.parametrize('tests', [tests, tests_unix])
def test_rcv_std_array_cplx_float(tests):
    arr = np.arange(1024, dtype='complex64')
